...
namespace Pizza_Ordering.DataProvider
{
    public class DbInitializer : DropCreateDatabaseAlways<ApplicationDbContext>
    {
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            {
                new FixPizza { Name = "Гавайська", Price = 96, IngredientItems = pizzaIngr1 },
                new FixPizza { Name = "Капрічіоза", Price = 111, IngredientItems = pizzaIngr2 },
                new FixPizza { Name = "Вегетеріанська", Price = 83, IngredientItems = pizzaIngr3 }
            };
