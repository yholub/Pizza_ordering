var payment = (function ($) {
    ...
    function ViewModel(pizzas) {
        ...
        self.payWithStripe = function (e) {
            e.preventDefault();
        }

        self.submitPayment = function (e) {
            console.log("cardNumber : " + self.cardNumber);
            console.log("cardCvc : " + self.cardCvc);
            console.log("cardExpMonth : " + self.cardExpMonth);
            console.log("cardExpYear : " + self.cardExpYear);
